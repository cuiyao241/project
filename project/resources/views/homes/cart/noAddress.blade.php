...
<h1 class="w3wthreeheadingaits" style="height:150px">Feel Shy</h1>
 <div id="collapseOne1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne1">
	<div class="panel-body panel_text">
		<span class="glyphicon glyphicon-ban-circle" aria-hidden="true" style="color:green;font-size:30px; margin-left:70px" > 您没有添加默认收货地址 请您去个人中心添加,个人中心在我的"一点钟"方向! 辛苦了!</span>
		<br><br>
