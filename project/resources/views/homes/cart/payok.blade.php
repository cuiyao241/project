...
<h1 class="w3wthreeheadingaits" style="height:150px">Congratulations! Success!</h1>
 <div id="collapseOne1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne1">
	<div class="panel-body panel_text">
		<span class="glyphicon glyphicon-ok" aria-hidden="true" style="color:green;font-size:30px; margin-left:70px" > 恭喜您、支付成功！</span>
		<br><br>
		<span style="float:right;margin-right:140px;height:20px"><span class="label label-warning" style="font-size:15px"><a href="/home" >继续购物</a></span> 
