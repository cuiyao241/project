     ...
     <!--        <button type="button" class="btn responsive-prev-btn" disabled="disabled">
        ...
        <div class="mws-panel-toolbar">
            <div class="btn-toolbar">
                <div class="btn-group">
                   <a href="/admin/goods/adds" class="btn">
                         <i class="icol-add">
                        </i>
                        </i>
                        添加商品
...
<!-- <div class="panel panel-default" >
    <div class="panel-heading" role="tab" id="headingOne">
      <h4 class="panel-title">
        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne" class="" style="color:blue" id="tits">
         aaaaaa
        </a>
      </h4>
    </div>
            ...
            -->           
                  {{$v->title}}
                     ...
                     @else
                         ...
                         <a href="/admin/goods/lists/{{$v->id}}" style='color:red'>{{$v->title}}</a>
                    ...
                    <td class=" ">
                     ...
                     @if(!in_array($v->id, $value))
                    <td class=" ">
                        [<a href="/admin/goods/edit/{{$v->id}}" style="color:orange">编辑</a> | <a href="/admin/goods/add/fen-{{$v->id}}" style='color:green'>添加</a>]
                    </td>
                    @else
                    <td class=" ">
                        [<a href="/admin/goods/edit/{{$v->id}}" style="color:orange">编辑</a> | <a href="/admin/goods/delete{{$v->id}}" style='color:red'>删除</a>]
                    </td>
                    @endif
                </tr>
                @endforeach
