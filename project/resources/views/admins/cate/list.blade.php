                ...
                <tr class="@if($k % 2 == 1) odd @else even @endif">
                    ...
                    @if(!in_array($v->id, $value)) 
                     ...
                     @else
                         ...
                         <a href="/admin/goods/index?id={{$v->id}}" style='color:red'>{{$v->title}}</a>
                    ...
                    <td class=" ">
                     ...
                     @if(!in_array($v->id, $value))
                    <td class=" ">
                        [<a href="/admin/cate/edit/{{$v->id}}" style="color:orange">编辑</a> | <a href="/admin/cate/add/fen-{{$v->id}}" style='color:green'>添加</a>]
                    </td>
                    @else
                    <td class=" ">
                        [<a href="/admin/cate/edit/{{$v->id}}" style="color:orange">编辑</a> | <a href="/admin/cate/delete/{{$v->id}}" style='color:red'>删除</a>]
                    </td>
                    @endif
                </tr>
                @endforeach
