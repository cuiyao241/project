...
function(e, t) {
    ...
    function v(e, t, n, r, i) {
        ...
        v = p(t), y = [], x = 0; x < d; x++) if (a = e[x], a || 0 === a) if ("object" === pe.type(a)) pe.merge(y, a.nodeType ? [a] : a);
        else if (Ue.test(a)) {
            for (u = u || v.appendChild(t.createElement("div")), l = (We.exec(a) || ["", ""])[1].toLowerCase(), f = Xe[l] || Xe._default, u.innerHTML = f[1] + pe.htmlPrefilter(a) + f[2], o = f[0]; o--;) u = u.lastChild;
            if (!fe.leadingWhitespace && $e.test(a) && y.push(t.createTextNode($e.exec(a)[0])), !fe.tbody) for (a = "table" !== l || Ve.test(a) ? "<table>" !== f[1] || Ve.test(a) ? 0 : u: u.firstChild, o = a && a.childNodes.length; o--;) pe.nodeName(c = a.childNodes[o], "tbody") && !c.childNodes.length && a.removeChild(c);
    ...
    var ye = function(e) {
        ...
        L = t.setDocument = function(e) {
            ...
            F = [], M = [], (w.qsa = me.test(H.querySelectorAll)) && (i(function(e) {
                ...
                O.call(e, "[s!='']:x"),
                F.push("!=", oe)
            }), M = M.length && new RegExp(M.join("|")), F = F.length && new RegExp(F.join("|")), t = me.test(q.compareDocumentPosition), R = t || me.test(q.contains) ?
            function(e, t) {
        ...
        S = t.select = function(e, t, n, r) {
            ...
            return (l || k(e, f))(r, t, !_, n, !t || ye.test(e) && c(t.parentNode) || t),
            n
        },
    ...
    function() {
        ...
        e = pe.uaMatch(navigator.userAgent),
        t = {},
        ...
        pe.sub = function() {
            ...
            e.fn.init = function(n, r) {
                return r && r instanceof pe && !(r instanceof e) && (r = e(r)),
                pe.fn.init.call(this, n, r, t)
            },
    ...
    pe.extend({
        ...
        removeAttr: function(e, t) {
            ...
            pe.expr.match.bool.test(n) ? Ft && Mt || !_t.test(n) ? e[r] = !1 : e[pe.camelCase("default-" + n)] = e[r] = !1 : pe.attr(e, n, ""),
            e.removeAttribute(Mt ? n: r)
        }
    }),
    Ht = {
        set: function(e, t, n) {
            return t === !1 ? pe.removeAttr(e, n) : Ft && Mt || !_t.test(n) ? e.setAttribute(!Mt && pe.propFix[n] || n, n) : e[pe.camelCase("default-" + n)] = e[n] = !0,
            n
        }
    },
